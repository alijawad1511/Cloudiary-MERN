        ...
        <>
            <div className='col-md-4'>
                <div className="card mb-3 bg-light note">
                    <i className="fa-regular fa-trash-can" onClick={() => { deleteNote(note._id); showAlert('Note deleted...','danger'); }} style={{ color: 'red',position: 'absolute',top: '10px',right: '10px',cursor: 'pointer' }}></i>
